    ...
    return sources.reduce(function (res, cur) {
      ...
      for (const key in cur) {
        if (typeof cur[key] === "object" && cur[key] !== null) {
          ...
          defaultsDeep(node[key], cur[key]);//因为现在是在sources里了，所以【this】不指向【qpumpkin】。
        } else if (res[key] === undefined) {
          node[key] = cur[key];
        }
      }
      return res;
    }, object);//在传参的时候绑定qpumpkin。
  },
...
console.log(qpumpkin.reduce([1, 2, 3, 4, 5, 6, 7],(a,b)=>a+b,100))
console.log(qpumpkin.defaultsDeep(
  {"a":{"b":2}},{"a":{"b":1,"c":3}}
));
console.log(qpumpkin.snakeCase('Foo Bar'));
console.log(qpumpkin.truncate('hi-diddly-ho there, neighborino', {
  'omission': ' [...]'
}));
console.log(qpumpkin.trim("  abc  "))
console.log(qpumpkin.upperCase("--foo-bar"));
console.log(qpumpkin.unescape("fred, barney, &amp; pebbles"));
console.log(qpumpkin.rangeRight(0))
console.log(qpumpkin.range(0))
console.log(qpumpkin.cloneDeep({"a":1,"b":[1,2,3,4]}));

let abc = function (a, b, c) {
  return [a, b, c];
};
let curried = qpumpkin.curry(abc);

console.log(curried(1)(qpumpkin,3)(2))

// let fliped = qpumpkin.flip(console.log);
// fliped(1,2,3,4,5)
// console.log([
//   { 'a': 2, 'b': 1 },{ 'a': 1, 'b': 2 }].filter(qpumpkin.conforms({'b':function(n) {return n>1;}})))
// console.log(qpumpkin.flow([Math.max,Math.pow])(1,2))
// console.log(qpumpkin.pickBy(
//   {'a':1,'b':'2','c':3},qpumpkin.isNumber
// ));
// console.log(qpumpkin.pick(
//   {'a':1,'b':'2','c':3},['a','c']
// ));

// console.log(qpumpkin.omit(
//   { 'a': 1, 'b': '2', 'c': 3 },["a","c"]
// ));
// console.log(qpumpkin.mergeWith(
//   {'a':[1],'b':[2]},{'a':[3],'b':[4]},function customizer(objValue,srcValue){if (Array.isArray(objValue)) {return objValue.concat(srcValue);}}
// ));
// console.log(qpumpkin.merge(
//   {'a':[{'b':2},{'d':4}]},{'a':[{ 'c': 3 },{'e': 5 }]}
// ));
// console.log(qpumpkin.mapValues(
//    {'fred':{'user':'fred','age':40 },'pebbles':{'user':'pebbles','age':1}},
//    "age"
// ))
// console.log(qpumpkin.mapKeys(
//   {'a': 1,'b':2},function(value, key) {return key + value;}));
// console.log(qpumpkin.invoke(
//   {'a':[{'b':{'c': [1, 2, 3, 4]}}]},'a[0].b.c.slice', 1,3
// ))
// console.log(qpumpkin.invertBy(
//   {'a':1,'b':2,'c':1},function(value) {return 'group' + value;}))
// console.log(qpumpkin.invert({ 'a': 1, 'b': 2, 'c': 1 }));
// console.log(qpumpkin.get({'a':[{'b':{'c': 3 }}]},'a[0].b.c'))
// console.log(qpumpkin.functions({a:1,b:2}));
// function Foo() {
//   this.a = 1;
//   this.b = 2;
// }
// Foo.prototype.c = 3;
// qpumpkin.forInRight(new Foo, function (value, key) {
//   console.log(key);
// });
// qpumpkin.forIn(new Foo, function (value, key) {
//   console.log(key);
// });

// console.log(qpumpkin.findLastKey({
//   'barney': {
//     'age': 36,
//     'active': true
//   },
...
// console.log(qpumpkin.defaultsDeep(
//   {'a':{'b':2}},{'a':{'b':1,'c': 3}}))
// console.log(qpumpkin.defaults({ 'a': 1 }, { 'b': 2 }, { 'a': 3 }))
// console.log(qpumpkin.at(
// {'a':[{'b':{'c':3}},4]},['a[0]b.c','a[1]']));
// console.log(qpumpkin.toFinite());
